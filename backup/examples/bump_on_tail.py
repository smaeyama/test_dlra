...
"""Run the existing scripts for a bump-on-tail example."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the bump-on-tail example with the existing scripts")
    parser.add_argument("--outdir", type=Path, default=REPO_ROOT / "examples" / "output" / "bump_on_tail")
...
def main() -> None:
    ...
    figure_path = args.outdir / "bump_on_tail_summary.png"
