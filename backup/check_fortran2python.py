...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--fortran-frq", default="data_fortran/frq.001")
    parser.add_argument("--python-mominzt", default="lingk_output/mominzt.nc")
    parser.add_argument("--fortran-mominzt", default="data_fortran/mominzt.001")
    parser.add_argument("--python-fkinzv", default="lingk_output/fkinzv.nc")
    parser.add_argument("--fortran-fkinzv-dir", default="data_fortran")
